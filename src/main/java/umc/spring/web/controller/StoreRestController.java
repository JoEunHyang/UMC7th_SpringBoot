...
public class StoreRestController {
    ...
    public ApiResponse<StoreResponseDTO.MissionPreViewListDTO> getMissionList(@ExistStore @PathVariable(name = "store_id") Long storeId, @CheckPage @RequestParam(name = "page") Integer page){
